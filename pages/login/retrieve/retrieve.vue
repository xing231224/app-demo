	...
	<view class="uni-content">
		...
		<uni-forms ref="form" :value="formData" err-show-type="toast">
			...
			<uni-forms-item name="code">
				<login-sms-form ref="shortCode" :phone="formData.phone" type="reset-pwd-by-sms" v-model="formData.code">
				</login-sms-form>
			</uni-forms-item>
		...
		<uni-popup-captcha @confirm="submit" v-model="formData.captcha" scene="reset-pwd-by-sms" ref="popup">
		</uni-popup-captcha>
	</view>
</template>
...
<script>
	...
	import {
		loginSmsForm
	} from '@/pages/login/components/index.js'
	export default {
		mixins: [mixin],
		components: {
			loginSmsForm
