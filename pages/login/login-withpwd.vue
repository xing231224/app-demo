...
<template>
	<view class="uni-content">
		<view class="login-logo">
			<image :src="logo" mode="widthFix" style="width: 120rpx;border-radius: 50%;margin:40rpx auto 0 ;display: block;"></image>
		</view>
		<!-- 顶部文字 -->
		...
		<!-- 带选择框的隐私政策协议组件 -->
		<login-agreements scope="login" ref="agreements"></login-agreements>
		...
		<!-- 悬浮登录方式组件 -->
		<login-fab-login ref="uniFabLogin"></login-fab-login>
	</view>
</template>

<script>
	import mixin from '@/pages/login/common/login-page.mixin.js';
	import {
		loginFabLogin,
		loginAgreements
	...
	export default {
		...
		methods: {
			...
			toRegister() {
				uni.navigateTo({
					url: this.config.isAdmin ? '/pages/login/register/register-admin' :
...
<style lang="scss" scoped>
	@import "@/pages/login/common/login-page.scss";
